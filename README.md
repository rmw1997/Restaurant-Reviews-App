...
A **Restaurant Reviews** Website is converted to mobile-ready web application by satisfying these requirements:
...
2. With your server running, visit the site: `http://localhost:8080` to experience the **Restaurant Reviews**
